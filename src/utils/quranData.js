...
// Helper to get global ayah index
// Returns { surah, ayah } for a 1-based global ayah index
// NOT needed for strict "15 ayahs per page linear" if we just iterate.
// But useful for "Target" calculation.
export const getTotalAyahs = () => 6236; 
